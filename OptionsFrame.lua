...
function GuiaPhermuth:CreateConfigPanel()
	local frame = CreateFrame("Frame", "GuiaPhermuthOptions", UIParent)
	GuiaPhermuth.optionsframe = frame
...
table.insert(UISpecialFrames, "GuiaPhermuthOptions")
