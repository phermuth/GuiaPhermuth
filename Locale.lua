...
if loc == "koKR" then localized = {
	...
	["The advanced quest tracker in the default UI will show these items. Enable this if you would rather have GuiaPhermuth's button."] = "기본 UI의 고급 퀘스트 추적에 해당 아이템이 보이도록 합니다. 만약 GuiaPhermuth의 버튼을 선호한다면 활성화하세요.",
...
GUIAPHERMUTH_LOCALE = localized and setmetatable(localized, {__index = function(t,i) return engrish[i] or i end})
